...
var PlexAPIClient = /** @class */ (function () {
    ...
    PlexAPIClient.prototype.getServers = function () {
        ...
        return new Promise(function (resolve) {
            request(options)
                .then(function (result) {
                util_2.parseXML(result).then(function (parsedResult) {
                    if (util_1.isUndefined(parsedResult.MediaContainer.Server))
    ...
    PlexAPIClient.prototype.getUsers = function () {
        ...
        return new Promise(function (resolve) {
            request(options)
                .then(function (result) {
                util_2.parseXML(result).then(function (parsedResult) {
                    if (util_1.isUndefined(parsedResult.MediaContainer.User))
    ...
    PlexAPIClient.prototype.getPendingUsers = function () {
        ...
        return new Promise(function (resolve) {
            request(options)
                .then(function (result) {
                util_2.parseXML(result).then(function (parsedResult) {
                    if (util_1.isUndefined(parsedResult.MediaContainer.Invite))
                        return resolve(users);
    ...
    PlexAPIClient.prototype.inviteUser = function (username, machineId, librarySectionIds) {
        var _this = this;
        if (librarySectionIds === void 0) { librarySectionIds = []; }
        if (this.accessToken === '')
    ...
    PlexAPIClient.prototype.getSessions = function (ip, port) {
        ...
        return new Promise(function (resolve) {
            request(options)
                .then(function (result) {
                util_2.parseXML(result).then(function (parsedResult) {
                    if (util_1.isUndefined(parsedResult.MediaContainer.Video))
